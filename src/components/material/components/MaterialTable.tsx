...
import type { MaterialTableProps } from '@app-types/components/material.types';
...
const MaterialTable: React.FC<MaterialTableProps> = ({
  ...
  const renderFilterDropdown = (column: string, options: string[], currentValue: string): React.ReactNode => (
