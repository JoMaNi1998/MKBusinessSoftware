...
import { formatPrice } from '../shared/customerUtils';

const CustomerStats = ({ customerProjects, customerTotalCosts, loadingCosts }) => {
  const activeProjects = customerProjects.filter((p) => p.status === 'Aktiv').length;
