...
interface CustomerFormModeProps {
  isOpen: boolean;
  onClose: () => void;
  isEdit: boolean;
  // Hook-Props
  ...
  handleSubmit: (onClose?: () => void) => void;
  handleLocalContactSubmit: () => void;
  // Zusätzliche Props vom Hook die ignoriert werden können
  [key: string]: unknown;
}

const CustomerFormMode: React.FC<CustomerFormModeProps> = ({
  isOpen,
  onClose,
  isEdit,
  // Hook-Props
      ...
      <form id="customer-form" onSubmit={onSubmit} className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            onChange={(e: ChangeEvent<HTMLInputElement>) => handleChange('firmennameKundenname', e.target.value)}
            className={cn(
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="md:col-span-2">
            ...
            <input
              ...
              onChange={(e: ChangeEvent<HTMLInputElement>) => handleChange('street', e.target.value)}
              className={cn(
                'w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent',
          ...
          <div>
            ...
            <input
              ...
              onChange={(e: ChangeEvent<HTMLInputElement>) => handleChange('houseNumber', e.target.value)}
              className={cn(
                'w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent',
        ...
        <div className="space-y-4">
          ...
          {/* Liste - Leere Anzeige ausblenden wenn Formular offen */}
          {contacts.length === 0 && !(showAddContact || editingContact) ? (
