...
import type { CustomerFiltersProps, CustomerMobileFiltersProps } from '@app-types/components/customer.types';
...
export const CustomerMobileFilters: React.FC<CustomerMobileFiltersProps> = ({
  searchTerm,
  setSearchTerm,
  hasActiveFilters,
  resetFilters
