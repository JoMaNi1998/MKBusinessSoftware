...
import type { PVBOMItem, UseBOMCalculationReturn } from '@app-types/components/pvConfigurator.types';

interface SummaryStepProps {
  calculatedBOM: PVBOMItem[];
  setCalculatedBOM: Dispatch<SetStateAction<PVBOMItem[]>>;
  warnings: string[];
  baseBOMWithWarnings: UseBOMCalculationReturn;
  materialsById: Map<string, Material>;
  resetBOMToRecommended: () => void;
...
const SummaryStep: React.FC<SummaryStepProps> = ({
  ...
  const renderTable = (items: (PVBOMItem & { originalIndex: number })[], title: string, bgColor: string, borderColor: string): React.ReactNode => {
