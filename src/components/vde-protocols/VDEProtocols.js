...
const VDEProtocols = () => {
  ...
  const handleEditProtocol = useCallback((protocolId) => {
  ...
  const onDeleteProtocol = useCallback((protocolId) => {
    ...
    <div className="h-full flex flex-col space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 flex-shrink-0">
        <div className="pl-12 sm:pl-0">
          ...
          <p className="mt-1 text-sm text-gray-600 hidden sm:block">Erstellen und verwalten Sie VDE-Prüfprotokolle</p>
        </div>
