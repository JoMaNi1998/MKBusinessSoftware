...
const Page1_Anlagenuebersicht = React.memo(function Page1_Anlagenuebersicht({
  vdeData,
  handleVdeDataChange,
}: PageProps) {
  return (
    ...
    >
          ...
          <tbody>
            {Array.from({ length: 3 }, (_, i) => (
              <tr key={i}>
                <td className="border border-gray-400 p-2">
                  <InputField
                    value={(vdeData as VDEData)[`inverterType${i + 1}`] as string}
                ...
                <td className="border border-gray-400 p-2">
                  <InputField
                    type="number"
                    value={(vdeData as VDEData)[`inverterPmaxDC${i + 1}`] as string}
                ...
                <td className="border border-gray-400 p-2">
                  <InputField
                    type="number"
                    value={(vdeData as VDEData)[`inverterPnomAC${i + 1}`] as string}
                ...
                <td className="border border-gray-400 p-2">
                  <InputField
                    type="number"
                    value={(vdeData as VDEData)[`inverterPmaxAC${i + 1}`] as string}
        ...
        {Array.from({ length: 2 }, (_, i) => (
          <div key={i} className="grid grid-cols-2 gap-8 mb-4">
            <div className="flex">
              ...
              <InputField
                value={(vdeData as VDEData)[`meterNumber${i + 1}`] as string}
            ...
            <div className="flex">
              ...
              <InputField
                value={(vdeData as VDEData)[`meterReading${i + 1}`] as string}
      ...
      <div className="mb-8">
        ...
        <p className="mb-4 text-sm">
          Ich/Wir bestätigen, dass alle Arbeiten fachgerecht und nach bestem Wissen ausgeführt
          wurden.
        </p>
        ...
        <div className="space-y-2">
          <CheckboxField
            field="noDefectsFound"
            label="Es wurden keine Mängel festgestellt"
        ...
        <div className="grid grid-cols-2 gap-8 mt-8">
          ...
          <div className="flex">
            ...
            <InputField
              value={vdeData.inspectorSignature}
              onChange={(val) => handleVdeDataChange('inspectorSignature', val)}
              className="flex-1"
            />
          </div>
        </div>
