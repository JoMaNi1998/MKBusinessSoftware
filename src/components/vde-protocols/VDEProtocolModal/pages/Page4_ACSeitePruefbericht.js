    ...
    <div className="page bg-white p-6 min-h-[297mm] w-[210mm] mx-auto" style={{ fontSize: '10px' }}>
      ...
      <div className="mb-4">
        ...
        <div className="flex items-center mb-2">
          ...
          <input type="number" value={vdeData.networkVoltage1 ?? 230} onChange={(e) => handleVdeDataChange('networkVoltage1', e.target.value)} className="w-12 px-1 mr-1 text-xs border-b border-gray-400 bg-transparent" />
          <span className="mr-2">/</span>
          <input type="number" value={vdeData.networkVoltage2 ?? 400} onChange={(e) => handleVdeDataChange('networkVoltage2', e.target.value)} className="w-12 px-1 mr-2 text-xs border-b border-gray-400 bg-transparent" />
