...
// Hooks
import { useLaborFactors } from './hooks';
      ...
      case 2:
        return (
          <PositionsStep
            ...
            onUpdateOfferField={(field, value) => setOfferData(prev => ({ ...prev, [field]: value }))}
            onUpdateConditions={(updates) => setOfferData(prev => ({
              ...prev,
              conditions: { ...prev.conditions, ...updates }
            }))}
            onUpdateTotals={(updates) => setOfferData(prev => ({
              ...prev,
