...
import { formatPrice, LABOR_FACTOR_LABELS } from '../../shared';
            ...
            return (
              <div key={factorType}>
                ...
                <select
                  ...
                  onChange={(e) => onLaborFactorChange(factorType, e.target.value)}
            ...
            return (
              <div key={category.id} className="space-y-2">
                ...
                <select
                  ...
                  onChange={(e) => onServiceSelection(category.id, e.target.value)}
