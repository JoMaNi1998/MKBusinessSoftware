...
import type { OfferListHeaderProps } from '@app-types/components/offer.types';

const OfferListHeader: React.FC<OfferListHeaderProps> = ({
  searchTerm,
  onSearchChange,
  visibleColumns,
  availableColumns,
  ...
  return (
    <div className="p-4 border-b border-gray-200 flex-shrink-0 space-y-3 sm:space-y-0">
      <div className="flex items-center justify-between sm:gap-3">
        <h2 className="text-lg font-semibold text-gray-900 flex-shrink-0">Angebotsliste</h2>
