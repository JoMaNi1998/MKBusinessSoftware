...
import { INVOICE_STATUS } from '../../../context/InvoiceContext';
import { useInvoiceConfigurator } from './useInvoiceConfigurator';
    ...
    <div className="h-dvh flex flex-col bg-gray-50">
      ...
      <div className="flex-shrink-0 bg-white border-t px-6 py-4">
        <div className="max-w-4xl mx-auto flex justify-between">
          <button
            onClick={hook.currentStep === 0 ? () => hook.navigate('/invoices') : hook.handleBack}
          ...
          {hook.currentStep < 3 ? (
            ...
            <button
              onClick={() => hook.handleSave(INVOICE_STATUS.SENT)}
