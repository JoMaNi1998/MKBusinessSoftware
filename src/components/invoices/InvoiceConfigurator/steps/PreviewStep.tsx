...
import type { InvoicePreviewStepProps } from '@app-types/components/invoice.types';

const PreviewStep: React.FC<InvoicePreviewStepProps> = ({
  invoiceData,
  customers,
  projects,
  selectedCustomer,
          ...
          <div className="flex justify-end mb-8">
            <div className="w-64">
              <div className="space-y-2 text-sm">
                ...
                {invoiceData.totals?.discountPercent && invoiceData.totals.discountPercent > 0 && (
                ...
                {(invoiceData.totals?.taxRate && invoiceData.totals.taxRate > 0) ? (
                  <div className="flex justify-between">
